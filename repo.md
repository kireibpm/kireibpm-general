...
| kireibpm-ui-designer-artifact-builder | IN_PROGRESS | 1893 | 394 | 2026-03-03 | Batch 1: testowe `utils`; Batch 2: `model.migrationReport`; Batch 3: `model.exception`; Batch 4: `model.fragment`; Batch 5: `model.data`; Batch 6: `model.asset`; Batch 7: `model.widget` + importy/resources do `org.kireibpm` |
