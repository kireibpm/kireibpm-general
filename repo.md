...
| kireibpm-ui-designer-artifact-builder | IN_PROGRESS | 1985 | 194 | 2026-03-02 | Batch 1: testowe `utils`; Batch 2: `model.migrationReport`; Batch 3: `model.exception`; Batch 4: `model.fragment`; Batch 5: `model.data` + importy do `org.kireibpm` |
